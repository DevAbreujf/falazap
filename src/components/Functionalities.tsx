...
const functionalities = [
  {
    ...
    description: "Você pode construir diferentes funis, da forma que preferir! Seja com arquivos de texto, áudio, imagem, vídeo, música ou outros documentos; al��m de programar o tempo de espera entre mensagens.",
...
export function Functionalities() {
  return <section id="functionalities" className="py-24 relative overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-b from-background via-background/50 to-background/80 bg-slate-50"></div>
    ...
    <div className="container mx-auto px-4 relative">
      ...
      <div className="space-y-32">
        {functionalities.map((item, index) => <div key={item.title} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-16 animate-fade-up`} style={{
