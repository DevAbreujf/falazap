  ...
  return (
    <div className="flex-1 hidden lg:block relative h-[500px]">
      <div className="glass-card p-8 rounded-[32px] h-full backdrop-blur-lg border border-white/10 relative overflow-hidden bg-[#7C3AED]/10 -translate-x-8">
        ...
        <div className="grid auto-rows-min gap-4 relative mt-4 px-4 h-[calc(100%-2rem)] overflow-y-auto">
          {/* Agent message */}
          <div className="flex items-start gap-3 max-w-[85%] animate-fade-in scale-95 hover:scale-100 transition-all duration-300">
            <div className="bg-gradient-to-br from-[#E8FFE5] to-[#D1FFE5] p-4 rounded-2xl rounded-tl-sm shadow-lg hover:shadow-xl transition-all">
            ...
            <span className="text-xs px-3 py-1 rounded-full bg-[#4CAF50]/20 text-[#4CAF50] font-semibold whitespace-nowrap shadow-sm">Agente IA</span>
          </div>
          ...
          <div className="flex items-start gap-3 justify-end max-w-[85%] ml-auto animate-fade-in scale-95 hover:scale-100 transition-all duration-300">
            <span className="text-xs px-3 py-1 rounded-full bg-[#9C27B0]/20 text-[#9C27B0] font-semibold whitespace-nowrap shadow-sm">Cliente</span>
            <div className="bg-gradient-to-br from-[#E8FFE5] to-[#D1FFE5] p-4 rounded-2xl rounded-tr-sm shadow-lg hover:shadow-xl transition-all">
          ...
          {[
            ...
            <div key={index} className="flex items-start gap-3 max-w-[85%] animate-fade-in scale-95 hover:scale-100 transition-all duration-300" style={{ animationDelay: `${index * 150}ms` }}>
              ...
              <span className="text-xs px-3 py-1 rounded-full bg-[#00BCD4]/20 text-[#00BCD4] font-semibold whitespace-nowrap shadow-sm">Chatbot</span>
            </div>
          ))}
        </div>
