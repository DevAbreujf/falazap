...
export function ChatPreview() {
  ...
  return (
    <div className="flex-1 hidden lg:block relative h-[600px]">
      <div className="glass-card p-6 rounded-3xl space-y-4 h-full backdrop-blur-lg border border-white/10 relative overflow-hidden bg-[#7C3AED]/10">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start gap-2">
            <div className="flex flex-col max-w-[80%]">
              <span className="text-xs px-2 py-1 rounded-full bg-[#4CAF50]/20 text-[#4CAF50] w-fit font-medium">Agente IA</span>
              <div className="bg-[#dcf8c7] p-3 rounded-xl mt-1 shadow-sm">
                <p className="text-sm text-gray-800">Boa tarde, Pedro, tudo certinho?</p>
                <span className="text-[10px] text-gray-500 text-right block mt-1">14:28</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2 justify-end">
            <div className="flex flex-col max-w-[80%]">
              <span className="text-xs px-2 py-1 rounded-full bg-[#9C27B0]/20 text-[#9C27B0] w-fit self-end font-medium">Cliente</span>
              <div className="bg-[#dcf8c7] p-3 rounded-xl mt-1 shadow-sm">
          ...
          <div className="flex items-start gap-2">
            <div className="flex flex-col max-w-[80%]">
              ...
              <div className="bg-[#dcf8c7] p-3 rounded-xl mt-1 shadow-sm">
                ...
                <span className="text-[10px] text-gray-500 text-right block mt-1">14:29</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2">
            <div className="flex flex-col max-w-[80%]">
              <span className="text-xs px-2 py-1 rounded-full bg-[#4CAF50]/20 text-[#4CAF50] w-fit font-medium">Agente IA</span>
              <div className="bg-[#dcf8c7] p-3 rounded-xl mt-1 shadow-sm">
                <p className="text-sm text-gray-800">Como te falei, essas são as informações que preciso:</p>
                <span className="text-[10px] text-gray-500 text-right block mt-1">14:31</span>
              </div>
            </div>
          </div>
          ...
          {[
            ...
            <div key={index} className="flex items-start gap-2">
              <div className="flex flex-col max-w-[80%]">
                <span className="text-xs px-2 py-1 rounded-full bg-[#00BCD4]/20 text-[#00BCD4] w-fit font-medium">Chatbot</span>
                <div className="bg-[#dcf8c7] p-3 rounded-xl mt-1 shadow-sm">
