...
export function ChatPreview() {
  ...
  return (
    <div className="flex-1 hidden lg:block relative h-[500px]">
      <div className="glass-card p-6 rounded-[32px] h-full backdrop-blur-lg border border-white/10 relative overflow-hidden bg-[#7C3AED]/10 -translate-x-8">
        <div className="absolute top-0 left-0 w-full h-16 bg-gradient-to-b from-background/80 to-transparent z-10" />
        
        {/* Messages container */}
        <div className="grid grid-rows-[repeat(auto-fit,minmax(0,1fr))] gap-3 relative mt-4 px-4 h-[calc(100%-2rem)]">
          {/* Agent message */}
          <div className="flex items-start gap-3 max-w-[85%] animate-fade-in scale-95 hover:scale-100 transition-all duration-300">
            ...
            <span className="text-[10px] px-3 py-1 rounded-full bg-[#4CAF50]/20 text-[#4CAF50] font-semibold whitespace-nowrap shadow-sm">Agente IA</span>
          </div>
          ...
          <div className="flex items-start gap-3 justify-end max-w-[85%] ml-auto animate-fade-in scale-95 hover:scale-100 transition-all duration-300">
            <span className="text-[10px] px-3 py-1 rounded-full bg-[#9C27B0]/20 text-[#9C27B0] font-semibold whitespace-nowrap shadow-sm">Cliente</span>
          ...
          {[
            ...
            <div key={index} className="flex items-start gap-3 max-w-[85%] animate-fade-in scale-95 hover:scale-100 transition-all duration-300" style={{ animationDelay: `${index * 150}ms` }}>
              ...
              <span className="text-[10px] px-3 py-1 rounded-full bg-[#00BCD4]/20 text-[#00BCD4] font-semibold whitespace-nowrap shadow-sm">Chatbot</span>
            </div>
          ))}
        </div>
