  ...
  return <div className="flex flex-col h-full">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit, onError)} className="space-y-4">
            ...
            field
                  ...
                  <FormControl>
                    <Input placeholder="Seu nome" {...field} className="bg-background/50 backdrop-blur-sm border-white/10 focus:border-primary" />
                  </FormControl>
                </FormItem>} />
            ...
            <Button type="submit" className="w-full gradient-primary  hover:shadow-lg hover:shadow-primary/20 bg-white text-black">
              Criar Conta
            </Button>
          </form>
        </Form>
      ...
      <div className="mt-auto p-6 border-t border-white/10">
        <div className="text-center space-y-2">
          ...
          <Button variant="outline" className="w-full hover-glow border-white/10 bg-secondary" onClick={onFlip}>
            Fazer Login
          </Button>
        </div>
      </div>
