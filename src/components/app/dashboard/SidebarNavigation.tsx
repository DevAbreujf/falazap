...
export function SidebarNavigation() {
  ...
  return <SidebarMenu className="">
      {menuItems.map(item => <SidebarMenuItem key={item.label} className="">
          <SidebarMenuButton onClick={item.onClick} className="group relative flex w-full items-center gap-3 rounded-lg p-2.5 transition-all duration-200 mx-0 my-[4px]">
