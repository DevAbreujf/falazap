...
export function Pricing() {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-gradient-to-b from-gray-900/5 via-transparent to-transparent" id="pricing">
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-16">
          <span className="inline-block px-4 py-2 rounded-full bg-gray-800/10 text-teal-600 text-sm font-medium mb-4 shadow-lg shadow-teal-500/10">
            PLANOS E PREÇOS
          </span>
