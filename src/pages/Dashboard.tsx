...
function DashboardContent() {
  ...
  return <div className="flex-1 overflow-hidden relative flex flex-col">
      <div className="absolute top-4 left-4 z-50 md:hidden">
        <Button variant="default" size="icon" className="bg-primary hover:bg-primary/90 text-white shadow-lg" onClick={() => setOpenMobile(true)}>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-4">
            <div className="w-full md:w-auto">
              <div className="flex items-center gap-3 mb-4">
                <Button variant="default" onClick={() => setIsPricingOpen(true)} className="w-full md:w-auto bg-emerald-400 hover:bg-emerald-300">
                  Atualizar plano
                </Button>
              </div>
      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="default" size="icon" className="fixed bottom-6 right-6 z-50 rounded-full w-14 h-14 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 bg-primary hover:bg-primary/90" onClick={() => {/* Add support action here */}}>
