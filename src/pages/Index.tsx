...
const Index = () => {
  ...
  const heroTitle = useMemo(() => {
    return <>
        ...
        <span className="relative">
          <span className="bg-gradient-to-r from-[#7C3AED] to-[#6D28D9] bg-clip-text transition-all duration-500 font-extrabold drop-shadow-[0_0_15px_rgba(124,58,237,0.5)] text-slate-50">
            {role}
          </span>
  ...
  return <div className="min-h-screen w-full">
      ...
      <main className="w-full" role="main">
        ...
        <section className="container mx-auto px-4 pt-32 pb-16 min-h-[700px] bg-[#135454]" aria-label="Hero Section">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center h-full">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="bg-[#7C3AED] hover:bg-[#6D28D9] w-full sm:w-auto" onClick={() => console.log('Começar Agora clicked')} aria-label="Começar Agora">
                  Começar Agora
                </Button>
                <Button size="lg" variant="outline" className="w-full sm:w-auto" onClick={() => console.log('Ver Demonstração clicked')} aria-label="Ver Demonstração">
                  Ver Demonstração
                </Button>
              </div>
            </div>
            <div className="relative w-full aspect-square p-8">
              <img src="/placeholder.svg" alt="AI Assistant Illustration" className="w-4/5 h-4/5 object-contain animate-float mx-auto" loading="lazy" width="500" height="500" />
            </div>
          </div>
        </section>
